...
`h12`, `standalone`) refines a base field/style, and its absence is the default. Prefer the named
members (`Canonical.YearNumeric`) over the raw strings. To split a symbol into those parts
programmatically, see [`decodeCanonical`](/reference/api#decodecanonical).
...
| `DayOfMonthSpacePadded` | `day-of-month/space-padded` | Day of month, blank-padded to width |
...
| `HourSpacePaddedH12` | `hour/space-padded/h12` | Hour 1–12, blank-padded to width |
| `HourNumericH23` | `hour/numeric/h23` | Hour 0–23 |
| `HourTwoDigitH23` | `hour/2-digit/h23` | Hour 0–23, 2-digit |
| `HourSpacePaddedH23` | `hour/space-padded/h23` | Hour 0–23, blank-padded to width |
