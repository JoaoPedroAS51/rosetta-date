...
export const expectations: Record<DialectName, Partial<Record<CanonicalToken, string>>> = {
  ...
  ldml: {
    ...
    [Canonical.WeekdayTwoDigit]: 'ee',
    [Canonical.DayPeriodAbbreviated]: 'a',
    [Canonical.DayPeriodWide]: 'aaaa',
    [Canonical.DayPeriodNarrow]: 'aaaaa',
    [Canonical.DayPeriodAbbreviatedExtended]: 'b',
    [Canonical.DayPeriodWideExtended]: 'bbbb',
    [Canonical.DayPeriodNarrowExtended]: 'bbbbb',
    [Canonical.DayPeriodAbbreviatedFlexible]: 'B',
    [Canonical.DayPeriodWideFlexible]: 'BBBB',
    [Canonical.DayPeriodNarrowFlexible]: 'BBBBB',
    [Canonical.HourNumericH12]: 'h',
    [Canonical.HourTwoDigitH12]: 'hh',
    [Canonical.HourNumericH23]: 'H',
    [Canonical.HourTwoDigitH23]: 'HH',
...
export const aliases: Partial<Record<EndpointName, ReadonlyArray<readonly [token: string, canonical: CanonicalToken]>>> = {
  ...
  'ldml': [
    ...
    ['L', Canonical.MonthNumeric],
    ['LL', Canonical.MonthTwoDigit],
    ['q', Canonical.QuarterNumeric],
    ['qq', Canonical.QuarterTwoDigit],
    ['c', Canonical.WeekdayNumeric],
    ['cc', Canonical.WeekdayTwoDigit],
    ...
    ['bb', Canonical.DayPeriodAbbreviatedExtended],
    ['bbb', Canonical.DayPeriodAbbreviatedExtended],
    ['BB', Canonical.DayPeriodAbbreviatedFlexible],
    ['BBB', Canonical.DayPeriodAbbreviatedFlexible],
